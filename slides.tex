...
\begin{frame}{Smooth Local Projections}
    ...
    of LP estimates $\hat{\beta}_k$ \bigskip
...
\begin{frame}{B-Splines}
    ...
    In short, this is really just smoothing the LP estimates $\hat{\beta}_k$ with linear combinations
    of polynomials (usually cubic)
...
\begin{frame}{Where does our project fit in?}
    ...
    Plan: write a generic python implementation of the SLP estimation procedure along with some 
    demonstrations with simulated and real data
